                       ...
                       <div class="col-md-8 offset-md-1">
                            ...
                            @csrf
                                <div class="form-group">
                                    ...
                                    <select name="division_id" class="form-control formselect"  id="division">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="departement_id" class="form-control formselect" id=departement >
                                        <option value=""> -- Select One --</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="place_of_birthday" class="form-control @error('place_of_birthday') is-invalid @enderror" value="{{ old('place_of_birthday') }}" placeholder="Jakarta">
