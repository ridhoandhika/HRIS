        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{url ('admin/employees')}}"> <i class="menu-icon fa fa-puzzle-piece"></i>Employee </a>
                    </li>
                    <li>
                        <a href="{{url ('admin/divisions')}}"> <i class="menu-icon fa fa-dashboard"></i>Division </a>
                    </li>    
                    <li>
                        <a href="{{url ('admin/departements')}}"> <i class="menu-icon fa fa-user"></i>Departement </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
